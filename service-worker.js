// Service Worker - Fitnexis
const CACHE_NAME = 'fitnexis-v1';
...
self.addEventListener('fetch', (event) => {
  ...
  // Supabase Auth / PostgREST: sempre vai para a rede (nunca cacheia)
  const bypassDomains = ['auth.supabase.com', 'supabase.co', 'rest.supabase.co'];
